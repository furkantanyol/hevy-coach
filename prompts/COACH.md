...
- `get-body-measurements` / `get-body-measurement` / `log-body-measurement` — Weight, body fat %, circumferences
- `create-workout` / `update-workout` — Log or correct a workout on the user's behalf
