# HevyCoach — Setup for ChatGPT

## How to Set Up

1. **Project Instructions:** Copy everything below the setup section into your ChatGPT Project's custom instructions (Project Settings → Instructions)
2. **MCP Server:** In ChatGPT Settings → Apps → Advanced → Developer Mode, add the MCP server URL: `https://your-server.com/mcp`
3. **Files:** Upload `training-history.md` as a project file for long-term tracking
